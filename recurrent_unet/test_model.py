...
def get_args():
    ...
    parser.add_argument('--pth', type=str, default='24')
    parser.add_argument('--window', type=int, default=5)
    parser.add_argument('--seq_len', type=int, default=20)
    parser.add_argument('--ckpt', type=str, default='/home/eunu/vid_stab/ckpt/rent_unet_5_20')
    parser.add_argument('--save_path', type=str, default='/home/eunu/vid_stab/ckpt/test1')
    parser.add_argument('--h5_path', type=str, default='/hdd/DeepStab/h5/58.h5')
